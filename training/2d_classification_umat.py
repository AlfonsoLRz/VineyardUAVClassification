...
network_name = get_name(network_type) + '_salinas'

config.batch_size = 256
config.num_training_splits = 1
config.num_test_splits = 1

hc_umat, null_class = load_salinas_umat(plot_hc=False, plot_mask=True)
